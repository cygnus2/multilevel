       subroutine subcabmar(beta,dirup,site)
!
! updating routine for a single link
!
      use lattsize
      use precdef
      use filecom
      ...
      real :: beta,sbeta
!      write(*,*)"updating site=",site,"direction=",dirup
!     Links at the i-th site and the j-th direction get updated
      i = site
      j = dirup
!      
