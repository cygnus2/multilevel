...
! Initializes to ordered gauge field configuration.
      ...
      umastloc(1,1,j,i)=dcmplx(1d0,0d0)
      umastloc(1,2,j,i)=dcmplx(0d0,0d0)
      umastloc(1,3,j,i)=dcmplx(0d0,0d0)
      umastloc(2,1,j,i)=dcmplx(0d0,0d0)
      umastloc(2,2,j,i)=dcmplx(1d0,0d0)
      umastloc(2,3,j,i)=dcmplx(0d0,0d0)
      umastloc(3,1,j,i)=dcmplx(0d0,0d0)
      umastloc(3,2,j,i)=dcmplx(0d0,0d0)
      umastloc(3,3,j,i)=dcmplx(1d0,0d0)
