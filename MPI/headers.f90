...
!!
  module paramod
        ...
        save
        integer :: rank, ierr
        integer, parameter :: tsloc=leng4/itdim
        integer, parameter :: activenodes=tsloc
...
!!
  module umastcom
      ...
      complex (kind=double), dimension(3,3,4,ncu*(tsloc+1)) :: umastloc
      complex (kind=double), dimension(3,3,4,ncu*tsloc) :: umastloc1
...
!!
  module stapcom 
      ...
      complex (kind=double), dimension(3,3,3,ncu) :: bndstp
      complex (kind=double), dimension(3,3,3,ncu) :: bndstp_r
